...
const AddAddressCompo = (props: { setshowAddAddressCompo: any }) => {
  ...
  return (
    <div className="MainContentInnerdiv">
      <div className={`${style.formComtainer} W-100`} style={{ width: '100%' }}>
        <div
        ...
        >
          ...
          <div className="account-body W-100" style={{ width: '100%' }}>
            {customer && (

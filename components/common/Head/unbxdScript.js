  export const someUnbsdCategoryScripts = () => {
    console.log("is this unbxd coustom func is working ");
    console.log("window this", window.unbxdSearch );
      ...
      sort: {
        ...
        onEvent: (context, type) => {
          if (type === "BEFORE_API_CALL") {
              context.state.currentUrl = context.state.currentUrl.replace('pagetype=boolean')
          }
        },
      }
    })

    console.log("window this 002", window.unbxdSearch);
}

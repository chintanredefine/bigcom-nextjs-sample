...
import type { PaymentMethodEndpoint } from '.'

// Return wishlist info
const addPaymentMethod: PaymentMethodEndpoint['handlers']['addPaymentMethod'] =
  async ({ res, body: { customerToken, item }, config, commerce }) => {
    if (!item) {
